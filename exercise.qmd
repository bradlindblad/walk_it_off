...
workout_data <- tibble(
  ...
  Activity = c(
    ...
    "Sprint Interval", "Rest Interval", "Recovery Between Clusters",
    "Calorie Target"
  ),
  Instructions = c(
    "Moderate activity", "Moderate activity with oxygen",
    "All-out maximum effort", "Complete rest",  "Moderate pace after completing each cluster",
    "Continue at normal steady state"
  ),
  Duration = c(
    "2 minutes", "2 minutes",
    "20 seconds", "10 seconds", "2 minutes",
    "Until reaching 500 calories"
  ),
  Intensity = c(
    "Low (40-50%)", "Low (40-50%)",
    "Maximum (100%)", "None (0%)", "Moderate (40-60%)",
    "Moderate (60-70%)"
  )
)
